...
//				lFoto.setLocation( e.getX()-lFoto.getWidth()/2, e.getY()-lFoto.getHeight()/2 );
				int x1 = lFoto.getLocation().x+lFoto.getHeight()/2;
				int y1 = lFoto.getLocation().y+lFoto.getWidth()/2;
				int x2 = e.getX();
				int y2 = e.getY();
				...
				Thread t = new Thread(new Runnable() {
                    ...
                    public void run() {
                    	double t = 0.1;
                        while(t<=1) {
                        	int xt = (int) (x1 +t*(x2-x1));
                        	int yt = (int) (y1 +t*(y2-y1));
                        	t+=0.01;
                        	...
                        	SwingUtilities.invokeLater(new Runnable() {
                                ...
                                @Override
                                public void run() {
                                	lFoto.setLocation(xt-lFoto.getWidth()/2, yt-lFoto.getHeight()/2);
                                }
                            });
